...
<sub>按 `F` 或点「同花顺」，自动找出并选中手牌里的同花顺：![找同花顺](docs/preview-flush.png)</sub>
...
- **炸弹按阶梯使用**：AI 的炸弹代价随压制力单调递增（4 张炸 < 5 张炸 < 同花顺 < 6 张炸及以上），所以手里同时有 4 张 K 炸和同花顺时，会先用 4 张 K 炸，把同花顺留去压更大的炸
- **逢人配标记只标真正替代**：红桃级牌当自己用（凑对级牌、在顺子里按自然点数站位）**不算**使用逢人配；真正替代时会在牌型旁写明「配当♦4」，可以自己核对
